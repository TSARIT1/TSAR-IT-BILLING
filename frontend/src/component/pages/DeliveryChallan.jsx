...
function DeliveryChallan() {
  ...
  return (
    <PortalLayout title="Delivery Challan Management">
      <div className="delivery-challan-page-container animate-fade-in">
        {/* Modern Page Header */}
                  ...
                  <tr key={i}>
                    ...
                    <td>
                      <span className={`status-badge ${c.status.toLowerCase()}`}>
                        {c.status === "Open" ? <BsCheckCircleFill /> : <BsXCircleFill />}
                        {c.status}
                      </span>
                    </td>
                  </tr>
